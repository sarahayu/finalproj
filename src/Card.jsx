...
const TEXT = {
    ...
    7: `This is the average over 100 years. We can see that the areas of <span class="purple">unmet demand</span> does not necessarily correspond with areas of <span class="orange">demand</span>.`,
    8: `If we take a closer look at this region, we can investigate what might have contributed to this inequity.`,
    9: `If we overlay the map with land holders, we can see that exchange holders, symbolized with cows, are the ones predominantly demanding high amounts of <span class="orange">demand</span>. However, they aren’t suffering from as high <span class="purple">unmet demand</span>. In fact, they seem to be doing quite well.`,
    10: `What we should expect is more of the following. Here, a patch of land held by project holders are symbolized with a paper scroll. This area contends with high levels of <span class="purple">unmet demand</span>; this is expected, since it has high levels of <span class="orange">demand</span>.`,
    11: `On the other hand, settlement holders are similar to exchange holders in that they also historically have <span class="orange">high demand</span>, but get special treatment as well.`,
    12: `In fact, we can see on average, settlement and exchange land holders get higher water supply rates because they are higher priority; this is how they are able to maintain low average levels of unmet demand even though they have high average levels of demand.`,
    ...
    16: `This time, the rings indicate regions that are doing <span class="green">better</span> or <span class="purple">worse</span> than real-life, or historical, baselines.`,
...
export default function Card({ slide, transitioning }) {
    ...
    return (
        <div className="cardContainer">
            <p className='cardP' dangerouslySetInnerHTML={{__html: TEXT[slide % TEXT_LEN]}}></p>
        </div>
    )
}