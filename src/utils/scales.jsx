...
const p = d3.scaleQuantize().domain([-30, 30]).range(d3.range(0, 1, 1 / stepRes));
...
export const colorDiffHigh = colorInterpDifference(p.invertExtent(0.75)[0]);
export const colorDiffLow = colorInterpDifference(p.invertExtent(0.25)[0]);
